defmodule CoderacerWeb.FinishLive do
  ...
  def render(assigns) do
    ...
    <!-- Results Grid -->
      <div class="stats stats-vertical lg:stats-horizontal shadow mb-12">
        <div class="stat place-items-center">
          <div class="stat-title">Characters/Min</div>
          <div class="stat-value text-primary">{@cpm}</div>
        </div>
        ...
        <div class="stat place-items-center">
          ...
          <div class="stat-value text-info">{@session.time_completion}s</div>
        </div>

        <div class="stat place-items-center">
          <div class="stat-title">Errors</div>
          <div class="stat-value text-error">{@session.wrong}</div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div class="space-y-2 text-sm">
              ...
              <% else %>
                <p class="text-blue-400">• Practice regularly to improve your coding typing speed.</p>
              <% end %>
